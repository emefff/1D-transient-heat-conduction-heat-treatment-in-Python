...
num_time_intervals_cooling = 100 # must be a divisor of step_size_cooling
...
window_size = num_time_intervals_cooling * 2
polyorder = 3
...
heating_rate_surface_filtered = savgol_filter(heating_rate_surface, window_size, polyorder+1)
heating_rate_center_filtered = savgol_filter(heating_rate_center, window_size, polyorder+1)
